...
#' @param cumulative_variance_per_region A numeric value specifying the cumulative percentage of variance to be retained by the number of PCA components in the per region normalization. The default value is \code{70.0}.
...
infer_normality <- function(bam_file_path,
                            ref_file_path,
                            use_pca = TRUE,
                            use_pca_per_region = TRUE,
                            cumulative_variance = 95.0,
                            cumulative_variance_per_region = 70.0,
                            num_comp = NULL,
