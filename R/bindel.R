...
#' @param cumulative_variance_per_region A numeric value specifying the cumulative percentage of variance to be retained by the number of PCA components in the per region normalization. The default value is \code{20.0}.
...
infer_normality <- function(bam_file_path,
                            ...
                            cumulative_variance_per_region = 20.0,
                            num_comp = NULL,
